...
// Represents a Red Slime monster, extending the base Entity class.
public class MON_redSlime extends Entity {
    ...
    public MON_redSlime(GamePanel gp) {
        ...
        attack = 3;
        defense = 0;
        exp = 3;           // Experience points awarded upon defeat
        projectile = new OBJ_BlueRock(gp); // This monster can shoot rocks
    ...
    // Loads the sprites for the slime. The Red Slime uses the same sprite
    // for all directions, as is common for simple, spherical enemies.
    public void getImage(){
        up1 = setup("/monster/redslime_down_1",gp.tilesSize,gp.tilesSize);
        up2 = setup("/monster/redslime_down_2",gp.tilesSize,gp.tilesSize);
        down1 = setup("/monster/redslime_down_1",gp.tilesSize,gp.tilesSize);
        down2 = setup("/monster/redslime_down_2",gp.tilesSize,gp.tilesSize);
        left1 = setup("/monster/redslime_down_1",gp.tilesSize,gp.tilesSize);
        left2 = setup("/monster/redslime_down_2",gp.tilesSize,gp.tilesSize);
        right1 = setup("/monster/redslime_down_1",gp.tilesSize,gp.tilesSize);
        right2 = setup("/monster/redslime_down_2",gp.tilesSize,gp.tilesSize);
    }
